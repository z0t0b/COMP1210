...
public class Spherocylinder {
   ...
   /**
    * Compares object and returns either true or false.
    * @param obj for obj lol
    * @return false, or label, radius, and cylinder height.
    */
   public boolean equals(Object obj) {
      if (!(obj instanceof Spherocylinder)) {
         ...
         return (label.equalsIgnoreCase(d.getLabel())
            ...
            && Math.abs(cylHeight - d.getCylinderHeight()) < .000001);
      }
   }
